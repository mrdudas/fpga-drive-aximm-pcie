...
set_property LOC GTXE2_CHANNEL_X1Y16 [get_cells -hierarchical -regexp -filter { PRIMITIVE_TYPE == IO.GT.GTXE2_CHANNEL && PARENT =~  ".*axi_pcie_0.*" && NAME =~ ".*pipe_lane\[0\].*" }]
set_property LOC GTXE2_CHANNEL_X1Y17 [get_cells -hierarchical -regexp -filter { PRIMITIVE_TYPE == IO.GT.GTXE2_CHANNEL && PARENT =~  ".*axi_pcie_0.*" && NAME =~ ".*pipe_lane\[1\].*" }]
set_property LOC GTXE2_CHANNEL_X1Y18 [get_cells -hierarchical -regexp -filter { PRIMITIVE_TYPE == IO.GT.GTXE2_CHANNEL && PARENT =~  ".*axi_pcie_0.*" && NAME =~ ".*pipe_lane\[2\].*" }]
set_property LOC GTXE2_CHANNEL_X1Y19 [get_cells -hierarchical -regexp -filter { PRIMITIVE_TYPE == IO.GT.GTXE2_CHANNEL && PARENT =~  ".*axi_pcie_0.*" && NAME =~ ".*pipe_lane\[3\].*" }]
