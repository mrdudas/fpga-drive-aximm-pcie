...
set_property LOC GTHE4_CHANNEL_X0Y8  [get_cells -hierarchical -regexp -filter { PRIMITIVE_TYPE =~ ADVANCED.GT.GTHE4_CHANNEL && PARENT =~  ".*xdma_0.*" && NAME =~ ".*channel_inst\[0\].*" }]
set_property LOC GTHE4_CHANNEL_X0Y9  [get_cells -hierarchical -regexp -filter { PRIMITIVE_TYPE =~ ADVANCED.GT.GTHE4_CHANNEL && PARENT =~  ".*xdma_0.*" && NAME =~ ".*channel_inst\[1\].*" }]
set_property LOC GTHE4_CHANNEL_X0Y10 [get_cells -hierarchical -regexp -filter { PRIMITIVE_TYPE =~ ADVANCED.GT.GTHE4_CHANNEL && PARENT =~  ".*xdma_0.*" && NAME =~ ".*channel_inst\[2\].*" }]
set_property LOC GTHE4_CHANNEL_X0Y11 [get_cells -hierarchical -regexp -filter { PRIMITIVE_TYPE =~ ADVANCED.GT.GTHE4_CHANNEL && PARENT =~  ".*xdma_0.*" && NAME =~ ".*channel_inst\[3\].*" }]

############################
# SSD2 Gigabit transceivers
############################

set_property LOC GTHE4_CHANNEL_X0Y4 [get_cells -hierarchical -regexp -filter { PRIMITIVE_TYPE =~ ADVANCED.GT.GTHE4_CHANNEL && PARENT =~  ".*xdma_1.*" && NAME =~ ".*channel_inst\[0\].*" }]
set_property LOC GTHE4_CHANNEL_X0Y5 [get_cells -hierarchical -regexp -filter { PRIMITIVE_TYPE =~ ADVANCED.GT.GTHE4_CHANNEL && PARENT =~  ".*xdma_1.*" && NAME =~ ".*channel_inst\[1\].*" }]
set_property LOC GTHE4_CHANNEL_X0Y6 [get_cells -hierarchical -regexp -filter { PRIMITIVE_TYPE =~ ADVANCED.GT.GTHE4_CHANNEL && PARENT =~  ".*xdma_1.*" && NAME =~ ".*channel_inst\[2\].*" }]
set_property LOC GTHE4_CHANNEL_X0Y7 [get_cells -hierarchical -regexp -filter { PRIMITIVE_TYPE =~ ADVANCED.GT.GTHE4_CHANNEL && PARENT =~  ".*xdma_1.*" && NAME =~ ".*channel_inst\[3\].*" }]
