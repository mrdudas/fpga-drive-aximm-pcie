...
set_property LOC GTYE4_CHANNEL_X0Y8  [get_cells -hierarchical -regexp -filter { PRIMITIVE_TYPE =~ ADVANCED.GT.GTYE4_CHANNEL && PARENT =~  ".*xdma_0.*" && NAME =~ ".*channel_inst\[0\].*" }]
set_property LOC GTYE4_CHANNEL_X0Y9  [get_cells -hierarchical -regexp -filter { PRIMITIVE_TYPE =~ ADVANCED.GT.GTYE4_CHANNEL && PARENT =~  ".*xdma_0.*" && NAME =~ ".*channel_inst\[1\].*" }]
set_property LOC GTYE4_CHANNEL_X0Y10 [get_cells -hierarchical -regexp -filter { PRIMITIVE_TYPE =~ ADVANCED.GT.GTYE4_CHANNEL && PARENT =~  ".*xdma_0.*" && NAME =~ ".*channel_inst\[2\].*" }]
set_property LOC GTYE4_CHANNEL_X0Y11 [get_cells -hierarchical -regexp -filter { PRIMITIVE_TYPE =~ ADVANCED.GT.GTYE4_CHANNEL && PARENT =~  ".*xdma_0.*" && NAME =~ ".*channel_inst\[3\].*" }]

############################
# SSD2 Gigabit transceivers
############################

set_property LOC GTYE4_CHANNEL_X0Y12 [get_cells -hierarchical -regexp -filter { PRIMITIVE_TYPE =~ ADVANCED.GT.GTYE4_CHANNEL && PARENT =~  ".*xdma_1.*" && NAME =~ ".*channel_inst\[0\].*" }]
set_property LOC GTYE4_CHANNEL_X0Y13 [get_cells -hierarchical -regexp -filter { PRIMITIVE_TYPE =~ ADVANCED.GT.GTYE4_CHANNEL && PARENT =~  ".*xdma_1.*" && NAME =~ ".*channel_inst\[1\].*" }]
set_property LOC GTYE4_CHANNEL_X0Y14 [get_cells -hierarchical -regexp -filter { PRIMITIVE_TYPE =~ ADVANCED.GT.GTYE4_CHANNEL && PARENT =~  ".*xdma_1.*" && NAME =~ ".*channel_inst\[2\].*" }]
set_property LOC GTYE4_CHANNEL_X0Y15 [get_cells -hierarchical -regexp -filter { PRIMITIVE_TYPE =~ ADVANCED.GT.GTYE4_CHANNEL && PARENT =~  ".*xdma_1.*" && NAME =~ ".*channel_inst\[3\].*" }]
