...
set_property LOC GTXE2_CHANNEL_X1Y24 [get_cells -hierarchical -regexp -filter { PRIMITIVE_TYPE == IO.GT.GTXE2_CHANNEL && PARENT =~  ".*axi_pcie_0.*" && NAME =~ ".*pipe_lane\[0\].*" }]
set_property LOC GTXE2_CHANNEL_X1Y25 [get_cells -hierarchical -regexp -filter { PRIMITIVE_TYPE == IO.GT.GTXE2_CHANNEL && PARENT =~  ".*axi_pcie_0.*" && NAME =~ ".*pipe_lane\[1\].*" }]
set_property LOC GTXE2_CHANNEL_X1Y26 [get_cells -hierarchical -regexp -filter { PRIMITIVE_TYPE == IO.GT.GTXE2_CHANNEL && PARENT =~  ".*axi_pcie_0.*" && NAME =~ ".*pipe_lane\[2\].*" }]
set_property LOC GTXE2_CHANNEL_X1Y27 [get_cells -hierarchical -regexp -filter { PRIMITIVE_TYPE == IO.GT.GTXE2_CHANNEL && PARENT =~  ".*axi_pcie_0.*" && NAME =~ ".*pipe_lane\[3\].*" }]
