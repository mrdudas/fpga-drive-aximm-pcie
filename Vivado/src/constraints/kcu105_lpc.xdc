...
set_property LOC GTHE3_CHANNEL_X0Y8 [get_cells -hierarchical -regexp -filter { PRIMITIVE_TYPE =~ ADVANCED.GT.GTHE3_CHANNEL && PARENT =~  ".*axi_pcie_0.*" && NAME =~ ".*channel_inst\[0\].*" }]
